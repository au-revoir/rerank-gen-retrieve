...
class FeverDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'query': question, 'query_text': question_text, 'answer': answer, 'paragraphs': paragraph, 'candidates': candidates}
        return sample
    ...
    def _build(self, data):
        ...
        if self.rerank_type == 't0_gpt':
            ...
            answer = data['answer']
        elif self.rerank_type in ['bm25', 'bm25_with_background']:
        ...
        if self.rerank_type == 'double_rerank':
            ...
            input_text = "Statement: {}".format(self. _remove_newline(data['gpt_background']))
        #answer = data['answer'] 
        #answer = data['answers'] 
